                    ...
                    <div id='content'>
                        ...
                        <div id="contact" className='contact-container'>
                            <div class="container py-4 py-md-5 px-4 px-md-5 text-body-secondary">
                                <div class="row">
                                    <div class="contact-logo col-lg-3 mb-3">
                                        ...
                                        <div class="sub-footer ">
                                            <span class="mb-2">Jalan Semangka Raya, Telaga Murni,Cikarang Barat, Kab. Bekasi</span>
                                        </div>
                                    </div>
                                    <div class="link-nav col-6 col-lg-2 offset-lg-1 mb-3 mt-3">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="mb-2"><a href="#">Carrer</a></li>
                                        </ul>
                                    </div>
                                    <div class="link-nav col-6 col-lg-2 mb-3 mt-3">
                                        <h5 className='mb-3'>Policy</h5>
                                        <ul class="list-unstyled">
                                            <li class="mb-2"><a href="#about">FAQ</a></li>
                                            <li class="mb-2"><a href="#">Privacy</a></li>
                                            <li class="mb-2"><a href="#service">Shipping</a></li>
                                        </ul>
                                    </div>
                                    <div class="link-nav col-6 col-lg-2 mb-3 mt-3">
                                        <h5 className='mb-3'>Projects</h5>
                                        <ul class="list-unstyled">
                                            <li class="mb-2"><a href="https://piscexle.github.io/w3band/">The band</a></li>
                                            <li class="mb-2"><a href="https://piscexle.github.io/Music_player/">Music player</a></li>
                                            <li class="mb-2"><a href="https://piscexle.github.io/MyCV/">My CV</a></li>
                                        </ul>
                                    </div>
                                    <div class="link-nav col-6 col-lg-2 mb-3 mt-3">
                                        <h5 className='mb-3'>Get In Touch</h5>
                                        <ul class="list-unstyled">
                                            <li class="mb-2"><a href='https://chat.zalo.me/'>+84 905 617 321</a></li>
                                            <li class="mb-2"><a href="https://mail.google.com/mail/u/0/#inbox">letram1132002@gmail.com</a></li>
                                            <li class="mb-2"><a href="https://www.facebook.com/profile.php?id=100008118336402">Facebook</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
